...
<head>
    <meta charset="utf-8">
    <link rel="apple-touch-icon" sizes="76x76" href="{!! asset('vendor/dashboard/assets/static/img/apple-icon.png') !!}">
    <link rel="icon" type="image/png" sizes="96x96" href="{!! asset('vendor/dashboard/assets/static/img/favicon.png') !!}">
    ...
    <link href="{!! asset('vendor/dashboard/assets/static/css/themify-icons.css') !!}" rel="stylesheet">
...
<!--  Google Maps Plugin    -->
<script src="{!! asset('vendor/dashboard/assets/build/js/main.js') !!}"></script>
